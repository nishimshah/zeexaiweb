...
const NewsletterSignup = () => {
    ...
    return (_jsxs("form", { onSubmit: handleSubmit, className: "flex flex-col sm:flex-row gap-3 items-center mt-12 justify-center", children: [_jsx("input", { type: "email", value: email, onChange: e => setEmail(e.target.value), placeholder: "Your email", required: true, className: "flex-1 px-6 py-4 rounded-lg border border-blue-200 text-lg focus:outline-none focus:ring-2 focus:ring-blue-400 bg-white shadow-sm" }), _jsx("button", { type: "submit", className: "bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-8 py-4 rounded-lg font-bold text-lg shadow transition-colors", children: "Subscribe" }), status === 'success' && (_jsx("span", { className: "text-green-600 mt-4 text-center w-full font-medium", children: message })), status === 'error' && (_jsx("span", { className: "text-red-600 mt-4 text-center w-full font-medium", children: message }))] }));
};
const BlogPost = () => {
    const { postId } = useParams();
    const post = postId ? blogPosts[postId] : null;
    if (!post) {
        return (_jsx(Layout, { children: _jsxs("div", { className: "container-default py-20 text-center", children: [_jsx("h1", { className: "text-3xl font-bold mb-6", children: "Blog Post Not Found" }), _jsx("p", { className: "mb-8", children: "Sorry, the blog post you're looking for doesn't exist or has been moved." }), _jsx(Link, { to: "/blog", className: "btn-primary", children: "Back to Blog" })] }) }));
    }
    return (_jsxs(Layout, { showFooter: false, children: [_jsxs("div", { className: "relative min-h-[340px] md:min-h-[420px] flex items-end bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 overflow-hidden", children: [_jsx("img", { src: post.image, alt: post.title, className: "absolute inset-0 w-full h-full object-cover object-center opacity-70" }), _jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-black/90 via-black/70 to-black/30" }), _jsx("div", { className: "container-default relative z-10 pb-10 pt-16 md:pt-24", children: _jsxs("div", { className: "max-w-3xl mx-auto text-center animate-fade-in", children: [_jsxs(Link, { to: "/blog", className: "inline-flex items-center text-white/80 mb-6 hover:underline", children: [_jsx(ArrowLeft, { className: "h-4 w-4 mr-2" }), "Back to Blog"] }), _jsx("h1", { className: "text-white mb-4 font-bold text-3xl md:text-5xl lg:text-6xl leading-tight drop-shadow-2xl animate-fade-in", children: post.title }), _jsxs("div", { className: "flex flex-wrap items-center justify-center gap-6 text-white/90 text-base md:text-lg animate-fade-in", children: [_jsxs("div", { className: "flex items-center", children: [_jsx(Calendar, { className: "h-4 w-4 mr-2" }), _jsx("span", { children: post.date })] }), _jsxs("div", { className: "flex items-center", children: [_jsx(Clock, { className: "h-4 w-4 mr-2" }), _jsx("span", { children: post.readTime })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("img", { src: post.authorImage, alt: post.author, className: "w-10 h-10 rounded-full object-cover border-2 border-white shadow-md" }), _jsxs("div", { className: "text-left", children: [_jsx("p", { className: "text-white font-semibold leading-tight", children: post.author }), _jsx("p", { className: "text-white/80 text-xs md:text-sm", children: post.authorTitle })] })] })] })] }) })] }), _jsx("div", { className: "container-default py-8 md:py-16 flex justify-center", children: _jsx("div", { className: "flex flex-col w-full max-w-5xl items-center", children: _jsxs("article", { className: "w-full bg-white/95 rounded-3xl p-8 sm:p-12 md:p-16 shadow-2xl drop-shadow-2xl animate-fade-in border border-blue-100", children: [_jsx("style", { children: `
            ...
            ` }), _jsx("div", { className: "prose prose-lg max-w-none text-gray-900", children: _jsx("div", { dangerouslySetInnerHTML: { __html: post.content } }) }), _jsxs("div", { className: "mt-12 pt-10 border-t", children: [_jsx("h4", { className: "text-xl font-semibold mb-4", children: "Share this article" }), _jsxs("div", { className: "flex gap-4", children: [_jsx("button", { className: "p-2 bg-blue-600 text-white rounded-full hover:bg-blue-700", "aria-label": "Share on Facebook", onClick: () => {
                                                    const url = encodeURIComponent(window.location.href);
                                                    const title = encodeURIComponent(post.title);
                                                    window.open(`https://www.facebook.com/sharer/sharer.php?u=${url}&quote=${title}`, '_blank', 'noopener,noreferrer');
                                                }, children: _jsx(Facebook, { size: 22 }) }), _jsx("button", { className: "p-2 bg-sky-500 text-white rounded-full hover:bg-sky-600", "aria-label": "Share on Twitter", onClick: () => {
                                                    const url = encodeURIComponent(window.location.href);
                                                    const title = encodeURIComponent(post.title);
                                                    window.open(`https://twitter.com/intent/tweet?url=${url}&text=${title}`, '_blank', 'noopener,noreferrer');
                                                }, children: _jsx(Twitter, { size: 22 }) }), _jsx("button", { className: "p-2 bg-blue-800 text-white rounded-full hover:bg-blue-900", "aria-label": "Share on LinkedIn", onClick: () => {
                                                    const url = encodeURIComponent(window.location.href);
                                                    const title = encodeURIComponent(post.title);
                                                    window.open(`https://www.linkedin.com/shareArticle?mini=true&url=${url}&title=${title}`, '_blank', 'noopener,noreferrer');
                                                }, children: _jsx(Linkedin, { size: 22 }) })] })] }), _jsxs("div", { className: "mt-14", children: [_jsx("h4", { className: "text-xl font-semibold mb-4", children: "Subscribe to ZeexAI Insights" }), _jsx(NewsletterSignup, {})] }), _jsx("div", { className: "w-full flex justify-center mt-14", children: _jsxs("div", { className: "bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl p-8 shadow-lg flex flex-col items-center text-center animate-fade-in max-w-xs", children: [_jsx("img", { src: post.authorImage, alt: post.author, className: "w-24 h-24 rounded-full object-cover border-4 border-blue-200 mb-4 shadow-md" }), _jsx("h3", { className: "text-2xl font-bold text-gray-900 mb-1", children: post.author }), _jsx("p", { className: "text-gray-600 mb-2", children: post.authorTitle }), _jsx("p", { className: "text-gray-700 text-base", children: "Sujit Laware is the CTO of Zeex AI, passionate about building ethical, innovative AI solutions for real-world security challenges." })] }) })] }) }) }), _jsx("section", { className: "bg-zeex-50 py-16", children: _jsx("div", { className: "container-default", children: _jsxs("div", { className: "max-w-2xl mx-auto text-center", children: [_jsx("h2", { className: "text-2xl font-bold mb-4 text-zeex-800", children: "Subscribe to Our Newsletter" }), _jsx("p", { className: "text-gray-600 mb-6", children: "Stay updated with the latest insights in AI security, delivered straight to your inbox." }), _jsxs("form", { className: "flex flex-col sm:flex-row gap-3", children: [_jsx("input", { type: "email", placeholder: "Your email address", className: "flex-grow px-4 py-3 rounded-md border focus:outline-none focus:ring-2 focus:ring-zeex-500" }), _jsx("button", { type: "submit", className: "btn-primary whitespace-nowrap", children: "Subscribe" })] })] }) }) })] }));
};
