...
import { Home, Building, MapPin, ShoppingCart, ArrowRight, Check, Shield, Video, Bell, Cloud, Cpu, Database, Lock, Wifi, Banknote, Factory, TrafficCone, Globe, Calendar, Bus, Wrench, Smartphone } from 'lucide-react';
...
const ServiceDetail = () => {
    ...
    if (isLoading) {
        return (_jsx(Layout, { showFooter: false, children: _jsx("div", { className: "container py-20 text-center", children: _jsx("h1", { className: "text-4xl font-bold mb-6 text-gray-900", children: "Loading..." }) }) }));
    }
    if (!service) {
        return (_jsx(Layout, { showFooter: false, children: _jsx("div", { className: "container py-20 text-center", children: _jsxs(motion.div, { initial: { opacity: 0 }, animate: { opacity: 1 }, transition: { duration: 0.5 }, children: [_jsx("h1", { className: "text-4xl font-bold mb-6 text-gray-900", children: "Service Not Found" }), _jsx("p", { className: "mb-8 text-lg text-gray-600", children: "Sorry, the service you're looking for doesn't exist or has been moved." }), _jsx(Link, { to: "/services", className: "inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all", children: "View All Services" })] }) }) }));
    }
    const ServiceIcon = service.icon;
    return (_jsxs(Layout, { showFooter: false, children: [_jsxs("section", { className: "relative min-h-[80vh] md:min-h-[70vh] flex items-center justify-center bg-navy-900 overflow-hidden opacity-0 animate-fadeIn", children: [_jsx("div", { className: "absolute inset-0 overflow-hidden z-0", children: _jsx("div", { className: "absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-500/10 via-transparent to-transparent opacity-20" }) }), _jsx("div", { className: "container-default relative z-10 transform translate-y-4 animate-slideUp px-4", children: _jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [_jsxs("div", { className: "inline-flex items-center gap-2 rounded-full bg-blue-500/20 px-4 py-1.5 text-sm font-medium text-blue-200 backdrop-blur-sm mb-6", children: [_jsx(ServiceIcon, { className: "w-4 h-4" }), " AI Security Services"] }), _jsxs("h1", { className: "text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 leading-tight tracking-tight", children: [service.title, " ", _jsx("span", { className: "bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent", children: "Services" })] }), _jsx("p", { className: "text-xl text-gray-300 mb-8 animate-fadeInDelay max-w-3xl mx-auto", children: service.description }), _jsx("div", { className: "flex flex-col sm:flex-row justify-center gap-4", children: _jsxs(Link, { to: "/contact", className: "inline-flex items-center justify-center px-6 py-3.5 sm:px-8 sm:py-4 bg-white text-blue-900 font-semibold rounded-lg hover:bg-blue-50 transition-all duration-300 hover:shadow-lg", children: ["Request a Demo", _jsx("svg", { className: "w-4 h-4 sm:w-5 sm:h-5 ml-2", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M14 5l7 7m0 0l-7 7m7-7H3" }) })] }) })] }) }), _jsx("style", { children: `
    @keyframes fadeIn {
      from { opacity: 0; }
      to { opacity: 1; }
    }
  ...
  ` })] }), _jsx(motion.section, { initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.5 }, viewport: { once: true }, className: "py-12 bg-gradient-to-r from-blue-50 to-indigo-50", children: _jsx("div", { className: "container", children: _jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: service.stats.map((stat, index) => (_jsxs(motion.div, { initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.5, delay: index * 0.1 }, viewport: { once: true }, className: "bg-white p-8 rounded-xl shadow-sm text-center", children: [_jsx("div", { className: "text-4xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-2", children: stat.value }), _jsx("div", { className: "text-gray-600 font-medium", children: stat.label })] }, index))) }) }) }), _jsx(motion.section, { initial: "hidden", animate: "visible", variants: staggerContainer, className: "py-16 md:py-20 bg-white", children: _jsx("div", { className: "container", children: _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-12", children: [_jsxs(motion.div, { variants: fadeInUp, className: "lg:col-span-8", children: [_jsx(motion.div, { whileHover: { scale: 1.02 }, transition: { type: "spring", stiffness: 400, damping: 10 }, className: "overflow-hidden rounded-2xl shadow-2xl mb-12 border border-gray-200", children: _jsx("img", { src: service.image, alt: service.title, className: "w-full h-auto object-cover aspect-video" }) }), _jsx("div", { className: "prose prose-lg max-w-none prose-headings:text-gray-900 prose-p:text-gray-600 prose-li:text-gray-600 prose-strong:text-gray-900 prose-a:text-blue-600 hover:prose-a:text-blue-700", dangerouslySetInnerHTML: { __html: service.content } })] }), _jsxs(motion.div, { variants: fadeInUp, className: "lg:col-span-4 space-y-8", children: [_jsxs(motion.div, { whileHover: { y: -5 }, className: "bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 shadow-sm border border-blue-100", children: [_jsxs("div", { className: "flex items-center gap-4 mb-6", children: [_jsx("div", { className: "w-14 h-14 rounded-full bg-white flex items-center justify-center shadow-md", children: _jsx(ServiceIcon, { className: "h-6 w-6 text-blue-600" }) }), _jsx("h3", { className: "text-2xl font-bold text-gray-900", children: service.title })] }), _jsx("h4", { className: "font-semibold mb-4 text-gray-700", children: "Key Benefits" }), _jsx("ul", { className: "space-y-3 mb-8", children: service.benefits.map((benefit, i) => (_jsxs(motion.li, { className: "flex items-start gap-3", variants: fadeInUp, children: [_jsx("div", { className: "flex-shrink-0 mt-0.5", children: _jsx(Check, { className: "w-5 h-5 text-blue-500" }) }), _jsx("span", { className: "text-gray-700", children: benefit })] }, i))) }), _jsx(Link, { to: "/contact", className: "w-full flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all shadow-md hover:shadow-lg", children: "Request a Demo" })] }), _jsxs(motion.div, { whileHover: { y: -5 }, className: "bg-white rounded-2xl p-8 shadow-sm border border-gray-100", children: [_jsx("h3", { className: "text-xl font-bold mb-6 text-gray-900", children: "Explore Other Services" }), _jsx("div", { className: "space-y-4", children: Object.entries(servicesDetails)
                                                    .filter(([key]) => key !== serviceId)
                                                    .slice(0, 3) // Limit to 3 services
                                                    .map(([key, otherService]) => {
                                                    const OtherIcon = otherService.icon;
                                                    return (_jsx(motion.div, { whileHover: { x: 5 }, children: _jsxs(Link, { to: `/services/${key}`, className: "flex items-center gap-4 p-4 rounded-xl hover:bg-gray-50 transition-colors", children: [_jsx("div", { className: "w-12 h-12 rounded-xl bg-blue-50 flex items-center justify-center", children: _jsx(OtherIcon, { className: "h-5 w-5 text-blue-600" }) }), _jsxs("div", { children: [_jsx("h4", { className: "font-medium text-gray-900", children: otherService.title }), _jsxs("p", { className: "text-sm text-gray-500", children: [otherService.description.substring(0, 60), "..."] })] }), _jsx(ArrowRight, { className: "w-5 h-5 text-gray-400 ml-auto" })] }) }, key));
                                                }) })] })] })] }) }) }), _jsx(motion.section, { initial: { opacity: 0 }, whileInView: { opacity: 1 }, transition: { duration: 0.5 }, viewport: { once: true, margin: "-100px" }, className: "bg-gradient-to-b from-blue-50 to-white py-16 md:py-24", children: _jsxs("div", { className: "container", children: [_jsxs(motion.div, { initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.5 }, viewport: { once: true }, className: "text-center mb-16", children: [_jsx("h2", { className: "text-3xl md:text-4xl font-bold mb-4 text-gray-900", children: "Key Features" }), _jsxs("p", { className: "text-lg text-gray-600 max-w-3xl mx-auto", children: ["Our AI-powered features that are most commonly included in ", service.title.toLowerCase(), " packages:"] })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: service.features.map((feature, index) => (_jsx(motion.div, { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.5, delay: index * 0.1 }, viewport: { once: true }, children: _jsxs("div", { className: "group bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all h-full flex flex-col border border-gray-100", children: [_jsx("div", { className: "w-full h-48 rounded-xl overflow-hidden mb-6", children: _jsx("img", { src: feature.image, alt: feature.title, className: "w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" }) }), _jsx("h3", { className: "text-xl font-bold mb-3 text-gray-900 group-hover:text-blue-600 transition-colors", children: feature.title }), _jsx("p", { className: "text-gray-600 mb-6 flex-grow", children: feature.description })] }) }, index))) })] }) }), _jsx(motion.section, { initial: { opacity: 0 }, whileInView: { opacity: 1 }, transition: { duration: 0.5 }, viewport: { once: true, margin: "-100px" }, className: "bg-gradient-to-b from-white to-blue-50 py-16 md:py-24", children: _jsxs("div", { className: "container", children: [_jsxs(motion.div, { initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.5 }, viewport: { once: true }, className: "text-center mb-16", children: [_jsx("h2", { className: "text-3xl md:text-4xl font-bold mb-4 text-gray-900", children: "Recommended Services" }), _jsxs("p", { className: "text-lg text-gray-600 max-w-3xl mx-auto", children: ["Complementary services that work well with our ", service.title.toLowerCase(), " solution:"] })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: service.recommendedServices.map((recService, index) => {
                                const RecIcon = recService.icon;
                                return (_jsx(motion.div, { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.5, delay: index * 0.1 }, viewport: { once: true }, children: _jsxs("div", { className: "group bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all h-full flex flex-col border border-gray-100", children: [_jsx("div", { className: "w-14 h-14 rounded-xl bg-blue-50 flex items-center justify-center mb-6", children: _jsx(RecIcon, { className: "h-6 w-6 text-blue-600" }) }), _jsx("h3", { className: "text-xl font-bold mb-3 text-gray-900 group-hover:text-blue-600 transition-colors", children: recService.title }), _jsx("p", { className: "text-gray-600 mb-6 flex-grow", children: recService.description })] }) }, index));
                            }) })] }) }), _jsx("section", { className: "py-16 md:py-24 bg-white", children: _jsxs("div", { className: "container", children: [_jsxs(motion.div, { initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.5 }, viewport: { once: true }, className: "text-center mb-16", children: [_jsx("h2", { className: "text-3xl md:text-4xl font-bold mb-4 text-gray-900", children: "How It Works" }), _jsxs("p", { className: "text-lg text-gray-600 max-w-3xl mx-auto", children: ["Our ", service.title.toLowerCase(), " service follows a streamlined workflow to ensure optimal security:"] })] }), _jsxs("div", { className: "relative", children: [_jsx("div", { className: "absolute top-16 left-[calc(50%-1px)] h-[calc(100%-80px)] w-0.5 bg-gradient-to-b from-blue-200 to-indigo-200 hidden md:block" }), _jsx(motion.div, { variants: staggerContainer, initial: "hidden", whileInView: "visible", viewport: { once: true }, className: "space-y-16", children: service.workflow.slice(0, 6).map((step, index) => (_jsx(motion.div, { variants: fadeInUp, className: "relative", children: _jsxs("div", { className: `flex flex-col md:flex-row items-center gap-8 ${index % 2 === 1 ? 'md:flex-row-reverse' : ''}`, children: [_jsx("div", { className: "w-14 h-14 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white flex items-center justify-center font-bold text-xl relative z-10 shadow-lg", children: _jsx("span", { className: "text-2xl", children: step.icon }) }), _jsxs(motion.div, { whileHover: { scale: 1.02 }, className: "bg-white rounded-xl shadow-lg p-8 md:w-[calc(50%-40px)] relative border border-gray-100", children: [_jsx("h3", { className: "text-xl font-bold mb-3 text-gray-900", children: step.title }), _jsx("p", { className: "text-gray-600", children: step.description })] })] }) }, index))) })] })] }) }), _jsx(motion.section, { initial: { opacity: 0 }, whileInView: { opacity: 1 }, transition: { duration: 0.5 }, viewport: { once: true }, className: "py-20 bg-gradient-to-r from-blue-600 to-indigo-700 text-white", children: _jsxs("div", { className: "container text-center", children: [_jsxs("h2", { className: "text-3xl md:text-4xl font-bold mb-6", children: ["Ready to implement ", service.title, "?"] }), _jsx("p", { className: "text-lg mb-8 max-w-2xl mx-auto", children: "Contact us today to learn how our AI-powered security services can be tailored to your specific needs." }), _jsxs("div", { className: "flex flex-wrap justify-center gap-4", children: [_jsx(Link, { to: "/contact", className: "inline-flex items-center px-8 py-4 bg-white text-blue-600 font-medium rounded-xl hover:bg-gray-100 transition-all shadow-lg hover:shadow-xl", children: "Schedule a Consultation" }), _jsx(Link, { to: "/services", className: "inline-flex items-center px-8 py-4 border-2 border-white text-white font-medium rounded-xl hover:bg-white/10 transition-all", children: "Explore Other Services" })] })] }) })] }));
};
export default ServiceDetail;
//# sourceMappingURL=SolutionDetail.js.map